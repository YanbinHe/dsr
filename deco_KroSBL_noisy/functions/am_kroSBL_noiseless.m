function [metrics] = am_kroSBL_noiseless(y,A1,A2,A3,N,R_max,x)
...
%         A = A(:,index);
    ...
    [x_re,Sigma_x] = posterior_compute_noiseless(gamma1,gamma2,gamma3,A1,A2,A3,y);

    Lambda = abs(real(diag(Sigma_x))) + abs(x_re).^2;   
...
% re-estimate
[x_re,~] = posterior_compute_noiseless(gamma1,gamma2,gamma3,A1,A2,A3,y);
